...
function ScoreState:render()
    ...
    -- shows a different medal depending on the final score
    if self.score > 7 then
        love.graphics.draw(gold, VIRTUAL_WIDTH / 2 - 40, 120, 0, 0.025, 0.025)
    elseif self.score > 3 then
        love.graphics.draw(silver, VIRTUAL_WIDTH / 2 - 40, 120, 0, 0.025, 0.025)
    else
        love.graphics.draw(bronze, VIRTUAL_WIDTH / 2 - 40, 120, 0, 0.025, 0.025)
    end
